...
static int
DynArray_isValid(DynArray_T oDynArray)
{
...
void
DynArray_free(DynArray_T oDynArray)
{
  /* Free oDynArray. */
...
int
DynArray_getLength(DynArray_T oDynArray)
{
...
void
*DynArray_get(DynArray_T oDynArray, int iIndex)
{
...
void
*DynArray_set(DynArray_T oDynArray, int iIndex, const void *pvElement)
{
...
static void
DynArray_grow(DynArray_T oDynArray)
{
...
int
DynArray_add(DynArray_T oDynArray, const void *pvElement)
{
...
void
DynArray_addAt(DynArray_T oDynArray, int iIndex, const void *pvElement)
{
...
void
*DynArray_removeAt(DynArray_T oDynArray, int iIndex)
{
...
void
DynArray_toArray(DynArray_T oDynArray, void **ppvArray)
{
...
void
DynArray_map(DynArray_T oDynArray,
...
static void
DynArray_swap(const void *ppvArray[], int iOne, int iTwo)
{
