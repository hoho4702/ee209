...
/* Function to convert DynArray to char arrays and handle redirection */
void DynArray_parseTokens(DynArray_T oDynArray, char **CharArray, char **redirection);

/* Function to remove a range of elements from a DynArray */
void DynArray_removeRange(DynArray_T oTokens, int start, int end);
