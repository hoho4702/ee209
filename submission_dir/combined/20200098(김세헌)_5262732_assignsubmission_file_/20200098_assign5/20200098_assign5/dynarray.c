...
/* Name: Seheon Kim */
/* Student ID: 20200098 */
/* dynarray source code role: It efficiently manages memory and 
provides a function to expand or reduce the array. Through this, 
users can dynamically process data of unknown size in advance. */
...
void *DynArray_set(DynArray_T oDynArray, int iIndex,
  ...
  /* Assign pvElement to the iIndex'th element of oDynArray.  Return 
  the old element.
     It is a checked runtime error for oDynArray to be NULL.
     It is a checked runtime error for iIndex to be less than 0 or
     greater than or equal to the length of oDynArray. */
...
int DynArray_add(DynArray_T oDynArray, const void *pvElement)
  ...
  /* Add pvElement to the end of oDynArray, thus incrementing its 
length.
     It is a checked runtime error for oDynArray to be NULL. */
